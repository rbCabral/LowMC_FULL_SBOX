...
mat = [['0x00' for x in range(384)] for y in range(768)] 
mat2 = [['0x00' for x in range(384)] for y in range(768)] 
...
matRoundKey = [['0x00' for x in range(384)] for y in range(960)] 
mat2RoundKey = [['0x00' for x in range(384)] for y in range(960)] 
...
matRoundConstants = [['0x00' for x in range(384)] for y in range(4)] 
mat2RoundConstants = [['0x00' for x in range(384)] for y in range(4)] 
