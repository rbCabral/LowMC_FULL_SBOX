...
mat2 = [['0x00' for x in range(3)] for y in range(768)] 

mat7 = [['0x00' for x in range(192)] for y in range(768)] 
mat8 = [['0x00' for x in range(3)] for y in range(768)] 
...
mat3 = [['0x00' for x in range(192)] for y in range(960)] 
mat4 = [['0x00' for x in range(3)] for y in range(960)] 
...
mat = [['0x00' for x in range(192)] for y in range(4)] 
