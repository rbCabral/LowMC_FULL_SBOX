...
mat = [['0x00' for x in range(288)] for y in range(516)] 
mat2 = [['0x00' for x in range(288)] for y in range(516)] 
...
matRoundKey = [['0x00' for x in range(288)] for y in range(645)] 
mat2RoundKey = [['0x00' for x in range(288)] for y in range(645)] 
...
def orgRoundkey(m):
    ...
    for i in range (645):
        ...
        while(1):
            ...
            mat2RoundKey[i][k+16] = matRoundKey[i][j]
            j = (j + 9)
            k = k + 1
            if(k%16 == 0):
                k = k+16
            if(j > 128):
                mat2RoundKey[i][k] = '0x00'
                mat2RoundKey[i][k+16] = '0x00'
                k = k+1
                if(k%16 == 0):
                    k = k+16
                if(c > 2):
...
matRoundConstants = [['0x00' for x in range(288)] for y in range(4)] 
mat2RoundConstants = [['0x00' for x in range(288)] for y in range(4)] 
...
def orgRoundConstants(m):
    ...
    for i in range (4):
        ...
        while(1):
            ...
            mat2RoundConstants[i][k+16] = matRoundConstants[i][j]
            j = (j + 9)
            k = k + 1
            if(k%16 == 0):
                k = k+16
            if(j > 128):
                mat2RoundConstants[i][k] = '0x00'
                mat2RoundConstants[i][k+16] = '0x00'
                k = k+1
                if(k%16 == 0):
                    k = k+16
                if(c > 2):
